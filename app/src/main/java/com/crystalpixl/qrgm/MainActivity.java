...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBtn.setOnClickListener(view -> {
            if (imageUri == null){
                ...
                msg("Es wurde noch nichts gescant.");
            } else {
                try {
                    play();
                } catch (IOException e) {
        ...
        try {
            ...
            Task<List<Barcode>> barcodeResult = barcodeScanner.process(inputImage)
                    ...
                    .addOnFailureListener(e -> {
                            ...
                            msg("QR-Code konnte nicht gescant werden, weil "+e.getMessage());
                    });
        }
        catch (Exception e){
        ...
        for (Barcode barcode : barcodes) {
            ...
            if (id.equals(String.valueOf(rawValue.charAt(2)))){
                if (!values.contains(rawValue)) {
                    ...
                    qrcodenum++;
                    resultTv.setText("Erfolgreich gescant.");
                }
                else {
                    Toast.makeText(MainActivity.this, "Sie haben diesen QR-Code schon gescant.", Toast.LENGTH_SHORT).show();
                    msg("Sie haben diesen QR-Code schon gescant.");
                    Log.d(TAG, "extractBarCodeQRCodeInfo: Du hast diesen QR-Code schon gescant.");
                }
            }
            else {
    ...
    private void play() throws IOException {
        ...
        if (hashes.contains(md5(finalvalue))){
            ...
            builder.setMessage("Der gescannte Code wurde nicht auf Viren geprüft, fortfaheren?").setPositiveButton("Ja", dialogClickListener)
